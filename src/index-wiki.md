...
Generated 2026-08-02 from `src/wiki/`. 25 pages.
...
- **Bed Tax** — `src/wiki/bed-tax.md` — 12% Anchorage room tax on short-term lodging including hotels and STRs; ~$44M/yr, split three ways, with none of it dedicated to Girdwood. — tags: [economy, governance, policy, tourism] — words: 1633 — edited: 2026-08-01
...
- **Girdwood Economics and Labor Market** — `src/wiki/girdwood-economics-and-labor-market.md` — Tourism-dominated economy centered on Alyeska Resort, constrained by lack of worker housing. — tags: [economy, housing] — words: 159 — edited: 2026-04-25
...
- **Glacier Valley Transit (GVT)** — `src/wiki/glacier-valley-transit.md` — Free hourly shuttle along Girdwood's spine, ~$500k/yr, roughly half its riders visitors; funded mostly by an FTA grant that needs a $150k local match. — tags: [infrastructure, tourism, economy] — words: 871 — edited: 2026-08-02
...
- **Anchorage Municipal Funds** — `src/wiki/muni-funds.md` — A field guide to the 6 digit numbering system used for funds. — tags: [governance, economy] — words: 754 — edited: 2026-06-24
...
- **Property Tax Exemptions** — `src/wiki/property-tax-exemptions.md` — Anchorage property-tax exemptions (senior, disabled veteran, residential, nonprofit, etc.) that reduce taxable value for Girdwood property owners. — tags: [policy, housing, governance] — words: 356 — edited: 2026-06-24
- **Property Tax** — `src/wiki/property-tax.md` — Hub page for how property tax works in Anchorage and how it affects Girdwood property owners. — tags: [policy, governance, housing] — words: 136 — edited: 2026-06-24
- **Short-Term Rentals (STRs)** — `src/wiki/short-term-rentals.md` — Airbnb/VRBO listings competing with long-term housing supply in Girdwood. — tags: [housing, economy, policy] — words: 287 — edited: 2026-08-01
- **Tourism Improvement Projects (TIPs)** — `src/wiki/tourism-improvement-projects.md` — Slice of the 4% tourism-promotion bed tax withheld from Visit Anchorage starting 2026 and spent by the Assembly on visitor-facing projects; Girdwood is competing for the 2027 pool. — tags: [policy, governance, tourism, economy] — words: 1031 — edited: 2026-08-01
